...
-- display.report_error("user", "debug", "api url = " .. api_url)
-- goto done
        ...
        if status_code >= 200 and status_code < 300 then
            ...
            page.set_template_variable("html_file", post_id .. ".gmi")
...
function M.update_post()
    ...
    if status_code >= 200 and status_code < 300 then
        if submit_type == "Preview" then
            ...
            page.set_template_variable("html_file", h_json["post_id"] .. ".gmi")
            page.set_template_variable("original_slug", original_slug)
